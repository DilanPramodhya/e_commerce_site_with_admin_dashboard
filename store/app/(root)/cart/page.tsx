  ...
  return (
    <div className="flex gap-20 py-16 px-10 max-lg:flex-col">
      <div className="w-2/3  max-lg:w-full">
        ...
        <hr className="my-6 border-2 border-cyan-950" />
      ...
      <div className="w-1/3 max-lg:w-full flex flex-col gap-8 bg-gray-400 rounded-lg px-4 py-5">
